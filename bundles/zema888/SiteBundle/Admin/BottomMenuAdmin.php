...
class BottomMenuAdmin extends AbstractAdmin
{
    protected $classnameLabel = 'Нижнее меню';
    ...
    protected function configureShowField(ShowMapper $showMapper)
    {
        $showMapper
            ...
            ->add('pillar', null, array('label' => 'Колонка'))
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('link', null, [
                'label' => 'Ссылка',
                'help' => 'Для случая когда привязка не к странице, при привязке к странице не используется. Если нет ни страницы не ссылки выводится заголовок',
                'required' => false
            ])
            ->add('position', null, [
                'label' => 'Позиция',
